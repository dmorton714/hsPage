  ...
  <main class="welcome-page">
    <section class="welcome-hero">
      ...
      <div class="hero-stack">
        ...
        <div class="hero-content reveal reveal-up">
          ...
          <p class="hero-copy">
            Download your images from the MIT Sloan Sports Analytics Conference headshot booth, courtesy of STAATY.
          </p>
    ...
    <section class="story-section solution-section">
      ...
      <div class="story-copy reveal reveal-right">
        ...
        <p class="eyebrow blue">Download Your Images</p>
        <a class="image-link-button" :href="imageGalleryUrl">Link to Images</a>
        <p>
          Thank you for visiting the STAATY headshot booth at the MIT Sloan Sports Analytics Conference. 
          You can download your images and tag STAATY and MIT Sloan.
        </p>
      </div>
    </section>
